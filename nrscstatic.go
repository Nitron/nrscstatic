...
// that serves static files from either the disk or using nrsc (when the useNrsc argument
// is set to true).
func NrscStatic(path string, useNrsc bool) Handler {
	if useNrsc {
